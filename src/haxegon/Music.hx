...
class Music {
	...
	public static function play_sound(t:String, offset:Int = 0) {
	...
	public static function stop_sound() {
	...
	public static function load_sound(t:String, vol:Float = 1.0) {
	...
	public static function load_song(t:String, vol:Float = 1.0) {
	...
	public static function play_song(t:String, time:Int = 0) {
		if (currentsong !=t) {
